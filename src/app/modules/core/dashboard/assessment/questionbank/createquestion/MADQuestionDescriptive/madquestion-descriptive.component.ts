...
@Component({
  selector: 'app-madquestion-descriptive',
  templateUrl: './madquestion-descriptive.component.html',
  styleUrls: ['./madquestion-descriptive.component.css'],
})
export class MADQuestionDescriptiveComponent implements OnInit {
  DummyData = {
    correctAnswer: false,
  };
  @Input() ScrollID = null;
  ...
  submitAnswerTrue() {
    this.DummyData.correctAnswer = true;
  }
  submitAnswerFalse() {
    this.DummyData.correctAnswer = false;
  }
