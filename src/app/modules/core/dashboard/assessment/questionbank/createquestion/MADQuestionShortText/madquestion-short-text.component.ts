...
@Component({
  selector: 'app-madquestion-short-text',
  templateUrl: './madquestion-short-text.component.html',
  styleUrls: ['./madquestion-short-text.component.css'],
})
export class MADQuestionShortTextComponent implements OnInit {
  @Input() ScrollID = null;
